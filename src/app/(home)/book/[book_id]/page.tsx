...
import PlaceHoldButton from '@/components/place-hold-button'
            ...
            <div className="flex flex-col lg:flex-row p-4 pt-16 space-y-8 sm:space-x-4">
                ...
                <div className="flex-grow max-w-3xl">
                    ...
                    <p className="text-gray-700 leading-6 mb-6">
                        This is a heartfelt and nostalgic song that explores themes of missed connections,
                        unspoken words, and the lingering echoes of what could have been.
                        The lyrics weave a poetic story about someone who wrote a song for a loved one,
                        but they never got the chance to hear it. Through soft melodies and a mix of melancholic yet hopeful tones,
                        the song captures the bittersweet nature of memories and the desire to share one deepest emotions, even if it too late.
                        The gentle acoustic guitar and soulful vocals make it an intimate ballad that resonates with anyone who has ever left something unsaid.
                    </p>
                </div>
                ...
                <div className="flex flex-col space-y-2 flex-grow">
                    ...
                    {
                    <PlaceHoldButton book_id={p.book_id} />
                    }
                    {
